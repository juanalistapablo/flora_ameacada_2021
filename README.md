# flora_ameacada_2021
Esse projeto busca fazer análise de grande volume de dados a respeito da flora brasileira  ameaçada, com dados de  2014 e2021, em busca de insights.

# Reconhecimentos e Direitos Autorais 

@autor: [ Matheus D. C. Sousa e Juan Pablo Furtado Mondego] 
...
HAROLDO GOMES BARROSO FILHO, e colegas de curso. 

Copyright/License 
Este material é resultado de um trabalho acadêmico para a disciplina 
ALGORITMOS E ESTRUTURA DE DADOS I, sob a orientação do professor Dr. HAROLDO GOMES BARROSO FILHO
, semestre letivo 2024.2, curso Engenharia da Computação, 
